...
router.get('/dashboard', async (req, res) => {
    try {
      // 1. Основная статистика за сегодня
      ...
      // 2. График записей по дням на текущей неделе
      ...
      // 3. Предстоящие записи — ближайшие 10
      ...
      // 5. Последние действия из журнала
